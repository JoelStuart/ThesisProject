...
%hudps = dsp.UDPSender('LocalIPPortSource','Auto','RemoteIPAddress','10.82.31.214','RemoteIPPort',8051);
hudps = dsp.UDPSender('LocalIPPortSource','Auto','RemoteIPAddress','127.0.0.1','RemoteIPPort',8051);
...
%Send data to GPU -> the follwing arrays have been initialised above
...
%     j16 = int16(jj);
% 
%     xR = round(drawObjs(jj,1));
% 
%     yR = round(drawObjs(jj,2));
%     zR = round(drawObjs(jj,3));

    f = [int16(drawObjs(:,1)) int16(drawObjs(:,2)) int16(drawObjs(:,3))];
