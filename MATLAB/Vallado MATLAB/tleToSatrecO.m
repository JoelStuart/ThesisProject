...
function [satrec, startmfe, stopmfe, deltamin] = tleToSatrecO(whichconst, longstr1, ...
          longstr2, typerun,typeinput, sta, sto, del)

    global tumin radiusearthkm xke j2 j3 j4 j3oj2 

    deg2rad  =   0.01745329251994330;         %    % [deg/rad]
    xpdotp   =  229.1831180523293;   %   % [rev/day]/[rad/min]  
...
%     // ------------- initialize the orbit at sgp4epoch --------------
     sgp4epoch = satrec.jdsatepoch - juliandate(clock); % days since 0 Jan 1950
     [satrec] = sgp4initO(whichconst, satrec, satrec.bstar, satrec.ecco, sgp4epoch, ...
